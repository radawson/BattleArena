...
public interface StorageProvider {
     ...
     */
    CompletableFuture<Void> savePlayerData(PlayerSave playerSave);
    
    /**
     * Loads player data by UUID.
     * 
     * @param uuid The player's UUID
     * @return CompletableFuture containing Optional PlayerSave if found
     */
    CompletableFuture<Optional<PlayerSave>> loadPlayerData(UUID uuid);
