...
import org.clockworx.battlearena.event.action.types.BroadcastAction;
import org.clockworx.battlearena.event.action.types.ChangeGamemodeAction;
import org.clockworx.battlearena.event.action.types.ChangeRoleAction;
import org.clockworx.battlearena.event.action.types.ClearEffectsAction;
import org.clockworx.battlearena.event.action.types.ClearInventoryAction;
import org.clockworx.battlearena.event.action.types.DelayAction;
import org.clockworx.battlearena.event.action.types.FlightAction;
import org.clockworx.battlearena.event.action.types.GiveEffectsAction;
import org.clockworx.battlearena.event.action.types.GiveItemAction;
import org.clockworx.battlearena.event.action.types.HealthAction;
import org.clockworx.battlearena.event.action.types.JoinRandomTeamAction;
import org.clockworx.battlearena.event.action.types.KillEntitiesAction;
import org.clockworx.battlearena.event.action.types.LeaveAction;
import org.clockworx.battlearena.event.action.types.PlaySoundAction;
import org.clockworx.battlearena.event.action.types.ResetStateAction;
import org.clockworx.battlearena.event.action.types.RespawnAction;
import org.clockworx.battlearena.event.action.types.RestoreAction;
import org.clockworx.battlearena.event.action.types.RunCommandAction;
import org.clockworx.battlearena.event.action.types.SendMessageAction;
import org.clockworx.battlearena.event.action.types.StoreAction;
import org.clockworx.battlearena.event.action.types.TeardownAction;
import org.clockworx.battlearena.event.action.types.TeleportAction;
